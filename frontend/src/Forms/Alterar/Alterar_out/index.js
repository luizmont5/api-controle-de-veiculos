...
function Alterar_out() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('http://localhost:3036/api/saida/alterar', {
                method: 'PUT',
                headers: {
            ...
            if (result.error) {
                ...
                alert('Dados de Saída alterada com sucesso!');
            }

        } catch (error) {
            console.error('Erro ao enviar os dados:', error);
            alert('Erro ao alterar os dados da Saída.');
        }
    };
